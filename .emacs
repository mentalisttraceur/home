...
(use-package evil
    ...
    (define-key evil-motion-state-map " vuu" (git pull))
    (define-key evil-motion-state-map " vyy" (git push))
    (define-key evil-motion-state-map " vyY" (git push --force))
    (define-key evil-motion-state-map " vtt" (git push --tags))
    (define-key evil-motion-state-map " vtT" (git push --tags --force))
