...
(use-package evil
    ...
    (setq space-map-alias (make-sparse-keymap))
    (set-keymap-parent space-map-alias space-map)
    (define-key evil-motion-state-map "\C-@" 'space-map-alias)
    (define-key evil-motion-state-map [?\C- ] 'space-map-alias)
    (define-key evil-insert-state-map "\C-@" 'space-map-alias)
    (define-key evil-insert-state-map [?\C- ] 'space-map-alias)
    (define-key evil-replace-state-map "\C-@" 'space-map-alias)
    (define-key evil-replace-state-map [?\C- ] 'space-map-alias)
    (define-key evil-emacs-state-map "\C-@" 'space-map-alias)
    (define-key evil-emacs-state-map [?\C- ] 'space-map-alias)
...
(defun histdir-repl-evil-replace-up () (interactive)
    (evil-insert-state)
    (histdir-repl-cycle-up-history))
(defun histdir-repl-evil-replace-down () (interactive)
    (evil-insert-state)
    (histdir-repl-cycle-down-history))
