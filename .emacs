...
(defun histdir-repl (command histdir)
    (let* ((program       (car command))
        ...
        (evil-local-set-key 'normal "cc" 'histdir-repl-delete-line+insert)
        (evil-local-set-key 'normal "C" 'histdir-repl-delete-line+insert)
...
(defun histdir-repl-beginning-of-line () (interactive)
    (buffer-process-send-string "\C-ax\b")
    (sleep-for 0.04)
    (point))
(defun histdir-repl-end-of-line () (interactive)
    (buffer-process-send-string "\C-ex\b")
    (sleep-for 0.04)
    (point))
...
(defun histdir-repl-insert () (interactive)
    (buffer-process-send-string "x\b")
    (sleep-for 0.04)
    (evil-insert-state))
(defun histdir-repl-insert-at-beginning () (interactive)
    (histdir-repl-beginning-of-line)
    (evil-insert-state))
(defun histdir-repl-append () (interactive)
    (buffer-process-send-string "\e[Cx\b")
    (sleep-for 0.04)
    (evil-insert-state))
