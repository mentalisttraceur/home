...
(use-package ace-window
    ...
    (defun window-state-kill-locked ()
        (window-state-kill t))
    (defun window-state-bury (&optional lock)
        (setq window-state--action 'aw-bury-buffer)
        (setq window-state window-state-bury)
        (setq window-state--loop-default lock)
        (setq window-state--loop t))
    (defun window-state-bury-locked ()
        (window-state-bury t))
