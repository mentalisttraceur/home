...
(use-package evil
    ...
    (define-key evil-motion-state-map " va" (lambda () (interactive)
        (pop-to-command-eshell '("git" "add" "-p") (vc-root-dir))))
    (define-key evil-motion-state-map " vq" (lambda () (interactive)
        (pop-to-command-eshell '("git" "checkout" "-p") (vc-root-dir))))
    (define-key evil-motion-state-map " vw" (lambda () (interactive)
