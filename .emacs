...
(use-package eat
    ...
    (defun fixed-eat-term-filter-string (eat-term-filter-string &rest arguments)
        (let ((inhibit-read-only t))
            (apply eat-term-filter-string arguments)))
    (advice-add 'eat-term-filter-string :around 'fixed-eat-term-filter-string)
