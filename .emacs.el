...
(use-package ace-window
    ...
    (define-key window-state-map "F" 'window-state-bury-operator)
    (define-key window-state-map "b" 'window-state-unbury)
    (define-key window-state-map "B" 'window-state-unbury-operator)
