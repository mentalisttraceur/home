...
(use-package evil
    ...
    (defun consult-history-remove-quit () (interactive)
        ...
        (vertico-exit))
    (defun consult-history-change (prefix-argument) (interactive "P")
    ...
    (defun consult-history-change-quit () (interactive)
...
(use-package denote
    ...
    (defun history-or-title-change (prefix-argument) (interactive "P")
