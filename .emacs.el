...
(when (and android (not termux))
    ...
    (define-translation ?1 'escape)
    (define-translation ?2 'control)
    (define-translation ?3 ?\C-i)
    (define-translation ?4 'left)
    (define-translation ?5 'down)
    (define-translation ?6 'up)
    (define-translation ?7 'right)
    (define-translation ?8 'deletechar)
    (define-translation ?9 'meta)
    (define-translation ?0 'escape)
